...
var REQUESTS_CONTRIBUTE_TO_STABILITY = new InjectionToken(
...
var HttpInterceptorHandler = class _HttpInterceptorHandler extends HttpHandler {
  ...
  static ɵfac = function HttpInterceptorHandler_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _HttpInterceptorHandler)(
...
var JsonpClientBackend = class _JsonpClientBackend {
  ...
  static ɵfac = function JsonpClientBackend_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _JsonpClientBackend)(
...
var JsonpInterceptor = class _JsonpInterceptor {
  ...
  static ɵfac = function JsonpInterceptor_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _JsonpInterceptor)(
      ɵɵinject(EnvironmentInjector),
    );
  };
  static ɵprov = ɵɵdefineInjectable({
...
var HTTP_TRANSFER_CACHE_ORIGIN_MAP = new InjectionToken(
...
function transferCacheInterceptorFn(req, next) {
  ...
  if (
    !isCacheActive ||
    requestOptions === false || // POST requests are allowed either globally or at request level
    (requestMethod === "POST" &&
      !globalOptions.includePostRequests &&
      !requestOptions) ||
    (requestMethod !== "POST" && !ALLOWED_METHODS.includes(requestMethod)) || // Do not cache request that require authorization when includeRequestsWithAuthHeaders is falsey
  ...
  const requestUrl =
    isServer && originMap ? mapRequestOriginUrl(req.url, originMap) : req.url;
...
function verifyMappedOrigin(url) {
  if (new URL(url, "resolve://").pathname !== "/") {
    throw new RuntimeError(
      2804,
      `Angular detected a URL with a path segment in the value provided for the \`HTTP_TRANSFER_CACHE_ORIGIN_MAP\` token: ${url}. The map should only contain origins without any other segments.`,
    );
  }
}
...
@angular/common/fesm2022/http.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-BD26NKK7.js.map
