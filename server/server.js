...
app.get('/scraper', async (req, res) => {
    try {
        ...
        const articles = await page.evaluate(() => {
            ...
            const headlineElements = document.querySelectorAll('h2[data-testid="card-headline"]');
            // Fetch all description elements
            const descriptionElements = document.querySelectorAll('p[data-testid="card-description"]');
            ...
            headlineElements.forEach((headlineElement, index) => {
                ...
                const description =
                    descriptionElements[index] && descriptionElements[index].innerText.trim();
